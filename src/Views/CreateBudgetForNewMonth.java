...
import classes.DataFormatter;
import classes.DatabaseReader;
import classes.DatabaseWriter;
import classes.GenerateComponents;
...
public class CreateBudgetForNewMonth extends JDialog {
	...
	private HashMap<Integer, Double> incomeMap = new HashMap<>();
	...
	//private java.sql.Date sqlDate = new java.sql.Date(time);   ///}dzisiejsza, da siê zapisac do bazy }razem 
	////////////////
	/**
