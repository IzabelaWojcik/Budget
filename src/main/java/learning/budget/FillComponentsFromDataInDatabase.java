...
public class FillComponentsFromDataInDatabase {
	...
	public static List<Transaction> fillTransactionList(List<Transaction> transactionsList, HashMap<Integer, String> categoryIdAndItsNameMap){
	...
	public static List<Transaction> fillTransactionIncomeList(List<Transaction> incomeList, HashMap<Integer, String> categoryIdAndItsNameMap, HashMap<Integer, String> usersMap){
		List<Transaction> transactions = new ArrayList<>();
	...
	public static List<Pair<String, Double>> fillTransactionIncomePairList(List<Transaction> incomeList, HashMap<Integer, String> usersMap){
